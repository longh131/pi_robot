...
# 混合模式分类
# LOCAL_ONLY: 只走本地识别，快速响应
# LLM_ONLY: 只走LLM识别，需要参数提取
LOCAL_ONLY_INTENTS = {
    # SYSTEM
    "SYSTEM_VOLUME_UP", "SYSTEM_VOLUME_DOWN", "SYSTEM_STOP", "SYSTEM_STATUS", "BATTERY_QUERY",
    # MOTOR
    "MOVE_FORWARD", "MOVE_BACKWARD", "TURN_LEFT", "TURN_RIGHT", "STOP",
    "SPEED_UP", "SPEED_DOWN", "FOLLOW_ME", "DANCE",
    # ENTERTAINMENT (无参数的)
    "TAKE_PHOTO", "PAUSE_MUSIC", "STOP_MUSIC", "NEXT_SONG", "PREV_SONG", "RESUME_MUSIC",
    # QUERY (本地查询)
    "TIME_QUERY", "DATE_QUERY", "WEATHER_QUERY", "NEWS_QUERY",
}
...
LLM_ONLY_INTENTS = {
    ...
    "REMINDER_SET", "REMINDER_QUERY", "REMINDER_DELETE", "ALARM_SET", "TIMER_SET",
    # ENTERTAINMENT (需要参数的)
    "PLAY_MUSIC", "START_RECORDING", "STOP_RECORDING",
    # QUERY (需要API的)
